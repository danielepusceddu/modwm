...
#else
static const char *fonts[]               = { "siji:pixelsize=17", "JetBrains Mono:pixelsize=15" };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask|ShiftMask, XK_r,          aspectresize,           {.i = -2z4} },
	...
	#if MOVESTACK_PATCH
	{ MODKEY,                       XK_KP_Left,    movestack,             {.i = +1 } },
	...
	{ MODKEY|Mod4Mask|ControlMask,  XK_8,          incrohgaps,             {.i = +1 } },
	...
	{ 0,                       		XK_KP_Home,     shiftview, {.i = -1} },
	{ 0,                       		XK_KP_Up,       shiftview, {.i = 1} },
	{ MODKEY,                       XK_KP_Home,       tagandviewtoleft,             {0} },
	{ MODKEY,                       XK_KP_Up,       tagandviewtoright,             {0} },
...
static Button buttons[] = {
	...
	{ ClkWinTitle,          0,                   Button3,        killclientclk, {0} },
